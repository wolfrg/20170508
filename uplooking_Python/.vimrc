...
let g:vim_bootstrap_langs = "ruby,python"
...
" ctags
set tags=/Users/bigv/yangdw/my_project/inject_base/general_task_client_inject_base/tags
set tags=./tags
set autochdir
...
"" ctrlp.vim
let g:ctrlp_map = '<leader>b'  "find all files
let g:ctrlp_cmd = 'CtrlP'
" 推荐
map <leader>hi :CtrlPMRU<CR>
"map <leader>C :CtrlPClearCache<cr>
let g:ctrlp_custom_ignore = {
    \ 'dir':  '\v[\/]\.(git|hg|svn|rvm)$',
    \ 'file': '\v\.(jpg|exe|so|dll|zip|tar|tar.gz|pyc)$'}
...
let g:syntastic_python_flake8_post_args='--ignore=E501,E228,E226,E261,E262,E128,E266,E265 --builtins=G,request'
